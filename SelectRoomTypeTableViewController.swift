...
class SelectRoomTypeTableViewController: UITableViewController, selectRoomTypeTableViewControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let roomType = RoomType.all[indexPath.row]
        self.roomType = roomType; delegate?
            .selectRoomTypeTableViewController(controller: self, didSelect: roomType)
